        ...
        <section class="flex w-full items-center justify-center bg-gradient-to-br from-[#eaf3fd] to-[#bcdff9] px-6 py-10 md:w-1/2">
            <div class="w-full max-w-sm">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="login_role" class="mb-2 block text-xs font-bold uppercase tracking-wide text-[#1e4fc4]">Login as</label>
                        <select id="login_role" name="login_role" class="w-full rounded-full border-0 bg-white px-5 py-3.5 text-base text-slate-800 shadow-sm outline-none ring-1 ring-transparent focus:ring-2 focus:ring-[#2f6fe0]">
